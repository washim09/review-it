            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-16">
              <div className="md:w-1/2 text-center md:text-left">
                ...
                <motion.p 
                  ...
                  className="text-base md:text-lg text-white/80 mb-10 leading-relaxed max-w-xl"
                >
                  Riviewit is a trusted review platform where people share authentic experiences about products, services, restaurants, travel, technology, fashion, health, and more. Read honest reviews with photos and videos, make informed decisions, and share your own experience to help others.
                </motion.p>
