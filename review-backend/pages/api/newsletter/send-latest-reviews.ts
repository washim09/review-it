    ...
    try {
      ...
      const emailHTML = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f5f5f5; padding: 20px;">
          <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
            <h1 style="color: white; margin: 0; font-size: 28px;">📝 Latest Reviews</h1>
            <p style="color: rgba(255,255,255,0.9); margin: 10px 0 0 0; font-size: 16px;">Discover what our community is reviewing</p>
          </div>
      ...
      const emailPromises = subscribers.map(async (subscriber) => {
        const msg = {
          ...
          subject: `🌟 Latest Reviews from Review-it Community`,
          html: emailHTML
        };
